...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ken/connect-microservice/gen/product/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// ProductServiceUpdateStockProcedure is the fully-qualified name of the ProductService's
	// UpdateStock RPC.
	ProductServiceUpdateStockProcedure = "/product.v1.ProductService/UpdateStock"
	// ProductServiceGetStockLevelProcedure is the fully-qualified name of the ProductService's
	// GetStockLevel RPC.
	ProductServiceGetStockLevelProcedure = "/product.v1.ProductService/GetStockLevel"
)
...
type ProductServiceClient interface {
	...
	UpdateStock(context.Context, *connect.Request[v1.UpdateStockRequest]) (*connect.Response[v1.UpdateStockResponse], error)
	// GetStockLevel returns the current stock and recent movement history.
	GetStockLevel(context.Context, *connect.Request[v1.GetStockLevelRequest]) (*connect.Response[v1.GetStockLevelResponse], error)
}
...
func NewProductServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProductServiceClient {
	...
	return &productServiceClient{
		...
		updateStock: connect.NewClient[v1.UpdateStockRequest, v1.UpdateStockResponse](
			httpClient,
			baseURL+ProductServiceUpdateStockProcedure,
			connect.WithSchema(productServiceMethods.ByName("UpdateStock")),
			connect.WithClientOptions(opts...),
		),
		getStockLevel: connect.NewClient[v1.GetStockLevelRequest, v1.GetStockLevelResponse](
			httpClient,
			baseURL+ProductServiceGetStockLevelProcedure,
			connect.WithSchema(productServiceMethods.ByName("GetStockLevel")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type productServiceClient struct {
	...
	getStockLevel *connect.Client[v1.GetStockLevelRequest, v1.GetStockLevelResponse]
}
...
// UpdateStock calls product.v1.ProductService.UpdateStock.
func (c *productServiceClient) UpdateStock(ctx context.Context, req *connect.Request[v1.UpdateStockRequest]) (*connect.Response[v1.UpdateStockResponse], error) {
	return c.updateStock.CallUnary(ctx, req)
}

// GetStockLevel calls product.v1.ProductService.GetStockLevel.
func (c *productServiceClient) GetStockLevel(ctx context.Context, req *connect.Request[v1.GetStockLevelRequest]) (*connect.Response[v1.GetStockLevelResponse], error) {
	return c.getStockLevel.CallUnary(ctx, req)
}
...
func NewProductServiceHandler(svc ProductServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	productServiceUpdateStockHandler := connect.NewUnaryHandler(
		ProductServiceUpdateStockProcedure,
		svc.UpdateStock,
		connect.WithSchema(productServiceMethods.ByName("UpdateStock")),
		connect.WithHandlerOptions(opts...),
	)
	productServiceGetStockLevelHandler := connect.NewUnaryHandler(
		ProductServiceGetStockLevelProcedure,
		svc.GetStockLevel,
		connect.WithSchema(productServiceMethods.ByName("GetStockLevel")),
		connect.WithHandlerOptions(opts...),
	)
	return "/product.v1.ProductService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case ProductServiceUpdateStockProcedure:
			productServiceUpdateStockHandler.ServeHTTP(w, r)
		case ProductServiceGetStockLevelProcedure:
			productServiceGetStockLevelHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedProductServiceHandler) UpdateStock(context.Context, *connect.Request[v1.UpdateStockRequest]) (*connect.Response[v1.UpdateStockResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("product.v1.ProductService.UpdateStock is not implemented"))
}

func (UnimplementedProductServiceHandler) GetStockLevel(context.Context, *connect.Request[v1.GetStockLevelRequest]) (*connect.Response[v1.GetStockLevelResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("product.v1.ProductService.GetStockLevel is not implemented"))
}
